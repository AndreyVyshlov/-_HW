...
student2.finished_courses = ['Java', 'Math', 'SQL', 'C++', 'C#']

lecturer1 = Lecturer('Jack', 'Vorobey')
lecturer1.courses = ['Python', 'SQL']

lecturer2 = Lecturer('Tony', 'Stark')
lecturer2.courses = ['Java', 'Math', 'C++', 'Python']

reviewer1 = Reviewer('Oleg', 'Tinkov')
reviewer1.courses_attached = ['SQL', 'Python', 'C++']
...
student1.lect_rate(lecturer1, 'Python', 7)
student2.lect_rate(lecturer1, 'Python', 5)
student1.lect_rate(lecturer2, 'Python', 3)
student2.lect_rate(lecturer2, 'Python', 10)
...
def lecturer_midgrades(lecturers, course):
    ...
    for lecturer in lecturers:
        for grade in lecturer.courses_grades.get(course):
            all_course_grades += [grade]
    mid_grade = sum(all_course_grades) / len(all_course_grades)
    print(f'Средняя оценка за курс {course}: {mid_grade}')

print(student1.grades)
print(lecturer1.courses_grades)
student_midgrades(students_list, courses[2])
lecturer_midgrades(lecturers_list, courses[2])
